			...
			<div class="x_panel">
				...
				<div class="x_content">
					<div class="table-responsive">
							...
							<table class="table table-striped jambo_table bulk_action"
								...
								<thead>
									<tr class="headings">
										...
										<th class="column-title centerField">View</th>
										</th>
						...
						<div class="pagination btn-group" id="pgt-recommendationRunning">
						</div>
					</div>
				</div>
			</div>
