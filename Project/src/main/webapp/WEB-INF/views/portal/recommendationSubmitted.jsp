					...
					<div class="table-responsive">
						<div class="title_right">
							...
							<div class="x_content" style="text-align: end;">
								...
								-->
								<button type="button" class="btn btn-warning btn-cancelmultiple">
									<span><i class="fa fa-stop"></i></span> Cancel
								</button>
						...
						<div id="loadingOverlay" style="min-height: 50px;">
							<table class="table table-striped jambo_table bulk_action"
								id="tbl-recommendationSubmitted">
								<thead>
									<tr class="headings">
										...
										<th class="column-title centerField">Cancel</th>
										</th>
							...
							<tbody>
								<c:forEach var="lsRe" items="${listRecommendation}">
									...
									<td class="a-center "><input type="checkbox" class="flat"
										...
										<td class=" last"><a href="#">View detail</a></td>
									</tr>
								</c:forEach>
							</tbody> -->
								<tbody>
						...
						<div class="pagination btn-group" id="pgt-recommendationSubmitted">
						</div>
					</div>
				</div>
			</div>
